...
public class MoveListener implements ActionListener {
    ...
    private boolean mushroomOccured;

    public MoveListener(JFrame frame, Field field, Player blueplayer, Player redPlayer, int col, int row, boolean mushroomOccured) {
        this.mushroomOccured = mushroomOccured;
        this.field = field;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (StarChooseListener.getCurrentStars() == 0) {
            
            if (blueplayer.getScore() > redPlayer.getScore()) {
                JOptionPane.showMessageDialog(null, "Ohhhhhhh! Guess What? The blue player won !!!!", "Game Ended", JOptionPane.INFORMATION_MESSAGE);
                toolkit.beep();
                frame.dispose();
            }
            
            if (blueplayer.getScore() < redPlayer.getScore()) {
                JOptionPane.showMessageDialog(null, "Ohhhhhhh! Guess What? The red player won !!!!", "Game Ended", JOptionPane.INFORMATION_MESSAGE);
                toolkit.beep();
                frame.dispose();
            }
            
            if (blueplayer.getScore() == redPlayer.getScore()) {
                JOptionPane.showMessageDialog(null, "Poooooof. No winners.", "Game Ended", JOptionPane.INFORMATION_MESSAGE);
                toolkit.beep();
                frame.dispose();
            }
